...
const VedicCore = (() => {
  ...
  const NAKSHATRAS = [
    { index: 0, name: 'Ashwini', lord: 'Ketu', deity: 'Ashwini Kumaras', start: 0, gana: 'Deva', quality: 'Light/Swift' },
    { index: 1, name: 'Bharani', lord: 'Venus', deity: 'Yama', start: 13.3333, gana: 'Manushya', quality: 'Fierce/Severe' },
    { index: 2, name: 'Krittika', lord: 'Sun', deity: 'Agni', start: 26.6667, gana: 'Rakshasa', quality: 'Mixed' },
    { index: 3, name: 'Rohini', lord: 'Moon', deity: 'Brahma', start: 40, gana: 'Manushya', quality: 'Fixed/Steady' },
    { index: 4, name: 'Mrigashira', lord: 'Mars', deity: 'Soma', start: 53.3333, gana: 'Deva', quality: 'Soft/Mild' },
    { index: 5, name: 'Ardra', lord: 'Rahu', deity: 'Rudra', start: 66.6667, gana: 'Rakshasa', quality: 'Sharp/Dreadful' },
    { index: 6, name: 'Punarvasu', lord: 'Jupiter', deity: 'Aditi', start: 80, gana: 'Deva', quality: 'Movable' },
    { index: 7, name: 'Pushya', lord: 'Saturn', deity: 'Brihaspati', start: 93.3333, gana: 'Deva', quality: 'Light/Swift' },
    { index: 8, name: 'Ashlesha', lord: 'Mercury', deity: 'Sarpa', start: 106.6667, gana: 'Rakshasa', quality: 'Sharp/Dreadful' },
    { index: 9, name: 'Magha', lord: 'Ketu', deity: 'Pitrs', start: 120, gana: 'Rakshasa', quality: 'Fierce/Severe' },
    { index: 10, name: 'Purva Phalguni', lord: 'Venus', deity: 'Aryaman', start: 133.3333, gana: 'Manushya', quality: 'Fierce/Severe' },
    { index: 11, name: 'Uttara Phalguni', lord: 'Sun', deity: 'Bhaga', start: 146.6667, gana: 'Manushya', quality: 'Fixed/Steady' },
    { index: 12, name: 'Hasta', lord: 'Moon', deity: 'Savitar', start: 160, gana: 'Deva', quality: 'Light/Swift' },
    { index: 13, name: 'Chitra', lord: 'Mars', deity: 'Tvashtar', start: 173.3333, gana: 'Rakshasa', quality: 'Soft/Mild' },
    { index: 14, name: 'Swati', lord: 'Rahu', deity: 'Vayu', start: 186.6667, gana: 'Deva', quality: 'Movable' },
    { index: 15, name: 'Vishakha', lord: 'Jupiter', deity: 'Indra-Agni', start: 200, gana: 'Rakshasa', quality: 'Mixed' },
    { index: 16, name: 'Anuradha', lord: 'Saturn', deity: 'Mitra', start: 213.3333, gana: 'Deva', quality: 'Soft/Mild' },
    { index: 17, name: 'Jyeshtha', lord: 'Mercury', deity: 'Indra', start: 226.6667, gana: 'Rakshasa', quality: 'Sharp/Dreadful' },
    { index: 18, name: 'Mula', lord: 'Ketu', deity: 'Nirriti', start: 240, gana: 'Rakshasa', quality: 'Fierce/Severe' },
    { index: 19, name: 'Purva Ashadha', lord: 'Venus', deity: 'Apas', start: 253.3333, gana: 'Manushya', quality: 'Fierce/Severe' },
    { index: 20, name: 'Uttara Ashadha', lord: 'Sun', deity: 'Vishvedevas', start: 266.6667, gana: 'Manushya', quality: 'Fixed/Steady' },
    { index: 21, name: 'Shravana', lord: 'Moon', deity: 'Vishnu', start: 280, gana: 'Deva', quality: 'Movable' },
    { index: 22, name: 'Dhanishta', lord: 'Mars', deity: 'Vasus', start: 293.3333, gana: 'Rakshasa', quality: 'Movable' },
    { index: 23, name: 'Shatabhisha', lord: 'Rahu', deity: 'Varuna', start: 306.6667, gana: 'Rakshasa', quality: 'Movable' },
    { index: 24, name: 'Purva Bhadrapada', lord: 'Jupiter', deity: 'Aja Ekapada', start: 320, gana: 'Manushya', quality: 'Fierce/Severe' },
    { index: 25, name: 'Uttara Bhadrapada', lord: 'Saturn', deity: 'Ahir Budhnya', start: 333.3333, gana: 'Manushya', quality: 'Fixed/Steady' },
    { index: 26, name: 'Revati', lord: 'Mercury', deity: 'Pushan', start: 346.6667, gana: 'Deva', quality: 'Soft/Mild' }
  ];
