...
const Interpretation = (() => {
  ...
  const ML_LAGNA_TRAITS = {
    0: { // Aries
      title: 'മുന്നിൽ നിന്ന് നയിക്കുന്ന വ്യക്തി',
      ...
      tags: ['കർമ്മനിരതർ', 'സ്വതന്ത്രർ', 'എടുത്തുചാട്ടം', 'ധീരർ', 'വിശ്രമമില്ലാത്തവർ']
    },
    1: { // Taurus
      ...
      tags: ['ക്ഷമാശീലർ', 'പ്രായോഗികം', 'ശാഠ്യം', 'സുഖലോലുപർ', 'വിശ്വസ്തർ']
    },
    2: { // Gemini
      title: 'ബഹുമുഖ ആശയവിനിമയ പ്രതിഭ',
      ...
      tags: ['സംസാരപ്രിയർ', 'അനുയോജ്യർ', 'കൗതുകമുള്ളവർ', 'അസ്ഥിരർ', 'സാമൂഹ്യർ']
    },
    3: { // Cancer
      title: 'സ്നേഹമയിയായ സംരക്ഷകർ',
      ...
      tags: ['പരിപാലകർ', 'ഉൾക്കാഴ്ചയുള്ളവർ', 'സംരക്ഷകർ', 'വൈകാരികം', 'കുടുംബസ്നേഹി']
    },
    4: { // Leo
      title: 'രാജകീയ നേതാവ്',
      ...
      tags: ['ആത്മവിശ്വാസമുള്ളവർ', 'ഉദാരമനസ്കർ', 'അഭിമാനി', 'സർഗ്ഗാത്മകർ', 'വിശ്വസ്തർ']
    },
    5: { // Virgo
      ...
      tags: ['വിശകലനാത്മകം', 'പ്രായോഗികം', 'വിമർശകർ', 'സേവനസന്നദ്ധർ', 'ഉത്കണ്ഠയുള്ളവർ']
    },
    6: { // Libra
      title: 'സന്തുലിതരായ നയതന്ത്രജ്ഞർ',
      ...
      tags: ['നയതന്ത്രജ്ഞർ', 'സന്തുലിതം', 'തീരുമാനമില്ലായ്മ', 'ആകർഷകം', 'സാമൂഹ്യർ']
    },
    7: { // Scorpio
      title: 'തീവ്രമായ പരിവർത്തകർ',
    ...
    8: { // Sagittarius
      title: 'തത്ത്വചിന്തകരായ യാത്രികർ',
      ...
      tags: ['ശുഭാപ്തിവിശ്വാസികൾ', 'സാഹസികർ', 'തുറന്നുപറയുന്നവർ', 'തത്ത്വചിന്തകർ', 'വിശ്രമമില്ലാത്തവർ']
    },
    9: { // Capricorn
      ...
      tags: ['ലക്ഷ്യബോധം', 'ഇച്ഛാശക്തി', 'പ്രായോഗികം', 'കഠിന പ്രകൃതം', 'ഉള്ളിൽ മൃദുവായവർ', 'വിശ്വാസക്കുറവ്', 'ഉത്കണ്ഠ/വിഷാദ സാധ്യത'],
      keywords: [
        { text: 'ലക്ഷ്യബോധം, പ്രായോഗികം', icon: 'Target' },
        { text: 'ഇച്ഛാശക്തി', icon: 'HandMetal' },
        { text: 'ഉള്ളിൽ മൃദുവായവർ', icon: 'Heart' },
        { text: 'കഠിന പ്രകൃതം', icon: 'User' },
    ...
    10: { // Aquarius
      ...
      tags: ['നൂതനം', 'സ്വതന്ത്രർ', 'അകൽച്ചയുള്ളവർ', 'മാനുഷികം', 'പ്രവചനാതീതം']
    },
    11: { // Pisces
      ...
      tags: ['അനുകമ്പയുള്ളവർ', 'ഭാവനാസമ്പന്നർ', 'ഒളിച്ചോടുന്നവർ', 'ആത്മീയർ', 'സെൻസിറ്റീവ്']
    }
  };
